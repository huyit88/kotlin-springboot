# Challenge 06: configuration-profile
...
### Run the Application
```bash
./gradlew :06-configuration-profile:bootRun
```

### Test the Application
```bash
# Run all tests
./gradlew :06-configuration-profile:test

# Build the project
./gradlew :06-configuration-profile:build
```
