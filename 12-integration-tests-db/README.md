# Challenge 12: db-integration-test
...
### Run the Application
```bash
./gradlew :12-db-integration-test:bootRun
```

### Test the Application
```bash
# Run all tests
./gradlew :12-db-integration-test:test

# Build the project
./gradlew :12-db-integration-test:build
```
