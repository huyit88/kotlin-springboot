# Challenge 11: testing-with-mocks
...
### Run the Application
```bash
./gradlew :11-testing-with-mocks:bootRun
```

### Test the Application
```bash
# Run all tests
./gradlew :11-testing-with-mocks:test

# Build the project
./gradlew :11-testing-with-mocks:build
```
